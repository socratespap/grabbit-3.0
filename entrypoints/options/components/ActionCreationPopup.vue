  ...
  <div v-if="isVisible" class="popup-overlay" @click="closePopup">
    <div class="popup-container" @click.stop>
      <div class="popup-header">
        <h2 class="popup-title">Create New Action - Step 1</h2>
...
const emit = defineEmits<{
  close: [];
  nextStep: [config: { mouseButton: string; modifiers: string[]; color: string; borderType: string; borderSize: number }];
}>();
...
const proceedToNextStep = () => {
  if (selectedMouseButton.value && selectedColor.value && selectedBorderType.value && selectedBorderSize.value) {
    emit('nextStep', {
